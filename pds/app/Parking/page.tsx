...
function ParkingInner() {
  ...
  React.useEffect(() => {
    ...
    const bg = nightMode ? '#0a0e14' : '#FFFFFF'
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-btn { width: 34px; height: 34px; border-radius: 6px; border: 1.5px solid ${colors.cardBorder}; background: ${colors.card}; color: ${colors.muted}; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.12s; }
        .icon-btn:hover { border-color: #3b82f6; color: #3b82f6; }
        .logout-btn { display: flex; align-items: center; gap: 0.375rem; padding: 0.4375rem 0.875rem; border-radius: 6px; border: 1.5px solid ${colors.cardBorder}; background: ${colors.card}; color: ${n ? '#f87171' : '#dc2626'}; font-size: 0.75rem; font-weight: 600; letter-spacing: 0.04em; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.12s; }
        .logout-btn:hover { border-color: #dc2626; background: ${n ? 'rgba(220,38,38,0.08)' : 'rgba(220,38,38,0.05)'}; }
        .admin-btn { display: flex; align-items: center; gap: 0.375rem; padding: 0.4375rem 0.875rem; border-radius: 6px; border: 1.5px solid rgba(220,38,38,0.35); background: rgba(220,38,38,0.08); color: #dc2626; font-size: 0.75rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.12s; }
        ...
        .history-title { font-size: 0.625rem; font-weight: 700; font-family: 'DM Sans', sans-serif; letter-spacing: 0.1em; text-transform: uppercase; color: ${colors.muted}; padding: 0.375rem 0.5rem 0.5rem; }
        ...
        .history-space { font-family: 'DM Sans', sans-serif; font-size: 0.8125rem; font-weight: 700; letter-spacing: 0.04em; color: #3b82f6; background: rgba(59,130,246,0.1); padding: 0.1rem 0.45rem; border-radius: 4px; flex-shrink: 0; }
        .history-plate { font-family: 'DM Sans', sans-serif; font-size: 0.75rem; font-weight: 600; letter-spacing: 0.08em; color: ${colors.text}; flex: 1; }
        .history-date { font-size: 0.6875rem; color: ${colors.muted}; flex-shrink: 0; }

        /* Stats bar */
        .stats-bar { position: relative; z-index: 5; display: flex; align-items: center; justify-content: center; gap: 2rem; padding: 0.875rem 1.5rem; background: #0a0e1a; flex-wrap: wrap; }
        ...
        .stat-pill { display: flex; align-items: center; gap: 0.625rem; font-family: 'DM Sans', sans-serif; font-size: 0.8125rem; font-weight: 400; color: rgba(255,255,255,0.45); letter-spacing: 0.04em; }
        .stat-dot { width: 7px; height: 7px; border-radius: 50%; flex-shrink: 0; }
        .stat-dot.green { background: #22c55e; box-shadow: 0 0 8px #22c55e; }
        .stat-dot.red   { background: #ef4444; box-shadow: 0 0 8px #ef4444; }
        .stat-dot.blue  { background: #3b82f6; box-shadow: 0 0 8px #3b82f6; }
        .stat-val { font-family: 'DM Sans', sans-serif; font-size: 1.125rem; font-weight: 700; color: #fff; letter-spacing: 0.02em; }
        .stat-sep { width: 1px; height: 20px; background: rgba(255,255,255,0.1); }
        ...
        .filter-btn { display: flex; align-items: center; gap: 0.375rem; padding: 0.4375rem 0.875rem; border-radius: 999px; border: 1.5px solid ${colors.cardBorder}; background: ${colors.card}; color: ${colors.muted}; font-size: 0.75rem; font-weight: 500; font-family: 'DM Sans', sans-serif; letter-spacing: 0.04em; cursor: pointer; transition: all 0.12s; }
        ...
        .row-label { font-family: 'DM Sans', sans-serif; font-size: 0.6875rem; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: ${n ? '#374151' : '#94a3b8'}; margin-bottom: 0.625rem; padding-left: 0.25rem; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid ${n ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.07)'}; padding-bottom: 0.375rem; }
        .row-toggle { display: flex; align-items: center; gap: 0.25rem; padding: 0.2rem 0.5rem; border-radius: 4px; border: 1.5px solid #3b82f6; background: rgba(59,130,246,0.08); color: #3b82f6; font-size: 0.625rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.12s; }
        ...
        .spot-btn { aspect-ratio: 1 / 1.2; border-radius: 5px; border: 1.5px solid transparent; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 3px; cursor: pointer; transition: all 0.12s; position: relative; overflow: hidden; font-family: 'DM Sans', sans-serif; }
        .spot-btn::after { content: none; }
        .spot-btn:hover::after { content: none; }
        .spot-btn:hover { transform: translateY(-2px) scale(1.04); }
        .spot-btn:active { transform: translateY(0) scale(0.98); }
        .spot-label { font-family: 'DM Sans', sans-serif; font-size: 0.6875rem; font-weight: 600; color: rgba(255,255,255,0.9); text-transform: uppercase; letter-spacing: 0.06em; line-height: 1; }

        .spot-available { background: ${n ? '#14532d' : '#16a34a'}; border-color: ${n ? '#166534' : '#15803d'}; box-shadow: 0 2px 8px rgba(22,163,74,0.25); }
        .spot-available:hover { transform: translateY(-2px) scale(1.04); box-shadow: 0 6px 16px rgba(22,163,74,0.35); }
        .spot-occupied  { background: ${n ? '#7f1d1d' : '#dc2626'}; border-color: ${n ? '#991b1b' : '#b91c1c'}; box-shadow: 0 2px 8px rgba(220,38,38,0.25); }
        .spot-occupied:hover  { transform: translateY(-2px) scale(1.04); }
        .spot-mine      { background: ${n ? '#1e3a8a' : '#2563eb'}; border-color: ${n ? '#1d4ed8' : '#1d4ed8'}; box-shadow: 0 2px 8px rgba(37,99,235,0.35); }
        .spot-mine:hover      { transform: translateY(-2px) scale(1.04); box-shadow: 0 6px 16px rgba(37,99,235,0.45); }
        ...
        .modal-card { width: 100%; max-width: 420px; background: ${colors.card}; border: 1.5px solid ${colors.cardBorder}; border-radius: 12px; overflow: hidden; box-shadow: ${n ? '0 32px 64px rgba(0,0,0,0.6)' : '0 24px 60px rgba(0,0,0,0.15)'}; animation: popIn 0.25s cubic-bezier(0.16,1,0.3,1) both; }
        .modal-inner { padding: 1.75rem; }
        .modal-accent { height: 4px; background: linear-gradient(90deg, #2563eb 0%, #3b82f6 60%, #93c5fd 100%); }

        /* Modal header */
        .modal-top { display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: 1.25rem; }
        .modal-badge { display: inline-flex; align-items: center; gap: 0.375rem; padding: 0.25rem 0.75rem; border-radius: 4px; font-size: 0.6875rem; font-weight: 700; font-family: 'DM Sans', sans-serif; letter-spacing: 0.06em; text-transform: uppercase; }
        ...
        .modal-sub { font-size: 0.875rem; color: ${colors.muted}; margin-bottom: 1.25rem; line-height: 1.5; }
        ...
        .modal-input { width: 100%; border: 1.5px solid ${colors.inputBorder}; border-radius: 6px; padding: 0.6875rem 0.875rem; font-size: 0.9375rem; font-family: 'DM Sans', sans-serif; outline: none; color: ${colors.inputText}; background: ${colors.inputBg}; transition: border-color 0.15s, box-shadow 0.15s; }
        ...
        /* Buttons */
        .modal-btn { width: 100%; border: none; border-radius: 7px; padding: 0.8125rem; font-size: 0.875rem; font-weight: 600; letter-spacing: 0.02em; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.12s; margin-bottom: 0.5rem; display: flex; align-items: center; justify-content: center; gap: 0.5rem; }
